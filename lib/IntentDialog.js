...
// --- class / interfaces ----------------------------------
function IntentDialog(app1,       // @arg String - app name 1.
                      app2,       // @arg String - app name 2.
...
IntentDialog["resource"] = {
    "en": {
        ...
        "APP": {
            "ICON":             "__ASSSET_DIR__/app.png",
            "CAPTION":          "APP",
            "PACKAGE":          "com.example.app",
            "REDIRECT_CAPTION": "Redirect to APP...",
        }
    }
};
...
function _localization(fragment, lang, redirectMode) {
    ...
    return fragment.replace("DIALOG.CAPTION",          redirectMode ? res[this._selected]["REDIRECT_CAPTION"]
                    ...
                    replace("APP.CAPTION",             res[this._app1]["CAPTION"]).
                    replace("APP.CAPTION",             res[this._app2]["CAPTION"]).
                    replace("APP.ICON",                res[this._app1]["ICON"]).
                    replace("APP.ICON",                res[this._app2]["ICON"]).
